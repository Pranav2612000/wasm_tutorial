import wasmInit from "./pkg/reading_writing_audio.js";
...
const runWasm = async () => {
    const rustWasm = await wasmInit("./pkg/reading_writing_audio_bg.wasm");
    ...
    const originalByteAudioSamples = floatSamplesToByteSamples(originalAudioSamples);
    ...
    const outputBuffer = wasmByteMemoryArray.slice(outputPointer, outputPointer + numberOfSamples);
